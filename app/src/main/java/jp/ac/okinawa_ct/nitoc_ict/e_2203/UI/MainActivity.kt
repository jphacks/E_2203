...
class MainActivity : AppCompatActivity() { //MainActivityクラス
    ...
    override fun onCreate(savedInstanceState: Bundle?) { //アプリ起動時の処理
        ...
        //テスト用↓ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
        ...
        setItemText(testval1, "野獣の照り焼き")
        setItemButton(testval2, "https://www.google.com/maps?client=firefox-b-d&q=%E6%9D%B1%E4%BA%AC%E9%83%BD%E4%B8%96%E7%94%B0%E8%B0%B7%E5%8C%BA%E5%8C%97%E6%B2%A2%EF%BC%93%E4%B8%81%E7%9B%AE%EF%BC%92%EF%BC%93%E2%88%92%EF%BC%91%EF%BC%94&um=1&ie=UTF-8&sa=X&ved=2ahUKEwjUwrzAke76AhVQY94KHTWkDpUQ_AUoAXoECAIQAw")
        setItemButton(testval3, "https://cookpad.com/dining/recipes/2762072")
    ...
    //Dishのメンバ（String）とViewの参照（インスタンス）を受け取り、反映させる関数2つーーーーーーー
